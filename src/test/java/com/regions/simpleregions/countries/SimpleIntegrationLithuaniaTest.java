...
class SimpleIntegrationLithuaniaTest {
    ...
    private final String PATH = "/api/v1/lithuania/plates";
    ...
    void getRegionHandle_whenGetLithuaniaPlatesByDescription_thenStatus200() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders
                        .get(PATH + "/description/Kaunas County")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON).header(headerName, authToken))
                .andExpect(status().isOk())
    ...
    @Test
    void getRegionHandle_whenGetLithuaniaWithoutApiKey_thenStatus200() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders
                        .get(PATH + "/region/")
                        .contentType(MediaType.APPLICATION_JSON)
