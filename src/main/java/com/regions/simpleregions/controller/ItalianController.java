...
public class ItalianController {
    ...
    public ResponseEntity getItalianPlatesByRegion(@Valid final @PathVariable("region") String region) {
        try {
    ...
    public ResponseEntity getItalianPlatesByDescription(@Valid final @PathVariable("description") String description) {
        try {
