...
public class MoldovaController {
    ...
    public ResponseEntity getMoldovaPlatesByRegion(final @PathVariable String region) {
        try {
    ...
    public ResponseEntity getMoldovaPlatesByDescription(final @PathVariable String description) {
        try {
