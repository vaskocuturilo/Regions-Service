...
public class LithuaniaController {
    ...
    public ResponseEntity getLithuaniaPlatesByRegion(@PathVariable String region) {
        try {
    ...
    public ResponseEntity getLithuaniaPlatesByDescription(@PathVariable String description) {
        try {
