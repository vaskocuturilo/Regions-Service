...
@Repository
public interface LithuaniaDiplomaticRepo extends CrudRepository<LithuaniaDiplomaticEntity, Long> {

    Optional<LithuaniaDiplomaticEntity> findByRegion(@PathVariable String region);

    @Query("select lithuania from LithuaniaDiplomaticEntity lithuania WHERE lithuania.description LIKE CONCAT('%',:description,'%')")
