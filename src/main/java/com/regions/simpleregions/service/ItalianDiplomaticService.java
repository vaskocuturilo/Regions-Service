...
import com.regions.simpleregions.respository.ItalianDiplomaticRepository;
import lombok.Data;
...
public class ItalianDiplomaticService {
    private final ItalianDiplomaticRepository italianDiplomaticRepository;
    ...
    public ItalianDiplomaticModel getItalianDiplomaticPlatesByRegion(final String region) throws RegionNotFoundException {
        ...
        Optional<ItalianDiplomaticEntity> italianRegion = italianDiplomaticRepository.findByRegion(region);
    ...
    public List<ItalianDiplomaticModel> getItalianDiplomaticPlatesByDescription(final String description) throws DescriptionNotFoundException {
        ...
        List<ItalianDiplomaticEntity> italianEntityList = italianDiplomaticRepository.findByDescription(description);
    ...
    public Iterable<ItalianDiplomaticEntity> getAllRegions() {
        ...
        return italianDiplomaticRepository.findAll();
    }
}
