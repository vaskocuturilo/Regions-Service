...
import com.regions.simpleregions.respository.PortugalDiplomaticRepo;
import lombok.Data;
...
public class PortugalDiplomaticService {
    ...
    private final PortugalDiplomaticRepo portugalDiplomaticRepo;
    ...
    public PortugalDiplomaticModel getPortugalDiplomaticPlatesByRegion(final String region) throws RegionNotFoundException {
        ...
        Optional<PortugalDiplomaticEntity> portugalRegion = portugalDiplomaticRepo.findByRegion(region);
    ...
    public List<PortugalDiplomaticModel> getPortugalDiplomaticPlatesByDescription(final String description) throws DescriptionNotFoundException {
        ...
        List<PortugalDiplomaticEntity> portugalEntityList = portugalDiplomaticRepo.findByDescription(description);
    ...
    public Iterable<PortugalDiplomaticEntity> getAllPortugalDiplomaticRegions() {
        ...
        return portugalDiplomaticRepo.findAll();
    }
}
