...
(180,'Województwo wielkopolskie, Chodzież','PCH'),
(181,'Województwo wielkopolskie, Czarnków','PCT'),
(182,'Województwo wielkopolskie, Gniezno','PGN'),
(183,'Województwo wielkopolskie, Gostyń','PGS'),
(184,'Województwo wielkopolskie, Grodzisk Wielkopolski','PGO'),
(185,'Województwo wielkopolskie, Jarocin','PJA'),
(186,'Województwo wielkopolskie, Kalisz powiat','PKA'),
(187,'Województwo wielkopolskie, Kępno','PKE'),
(188,'Województwo wielkopolskie, Koło','PKL'),
(189,'Województwo wielkopolskie, Konin powiat','PKN'),
(190,'Województwo wielkopolskie, Kościan','PKS'),
(191,'Województwo wielkopolskie, Krotoszyn','PKR'),
(192,'Województwo wielkopolskie, Leszno powiat','PLE'),
(193,'Województwo wielkopolskie, Międzychód','PMI'),
(194,'Województwo wielkopolskie, Nowy Tomyśl','PNT'),
(195,'Województwo wielkopolskie, Oborniki','POB'),
(196,'Województwo wielkopolskie, Ostrów Wielkopolski','POS'),
(197,'Województwo wielkopolskie, Ostrzeszów','POT'),
(198,'Województwo wielkopolskie, Piła','PP'),
(199,'Województwo wielkopolskie, Pleszew','PPL'),
(200,'Województwo wielkopolskie, Poznań powiat','POZ'),
(201,'Województwo wielkopolskie, Rawicz','PRA'),
(202,'Województwo wielkopolskie, Słupca','PSL'),
(203,'Województwo wielkopolskie, Szamotuły','PSZ'),
(204,'Województwo wielkopolskie, Środa Wielkopolska','PSR'),
(205,'Województwo wielkopolskie, Śrem','PSE'),
(206,'Województwo wielkopolskie, Turek','PTU'),
(207,'Województwo wielkopolskie, Wągrowiec','PWA'),
(208,'Województwo wielkopolskie, Wolsztyn','PWL'),
(209,'Województwo wielkopolskie, Września','PWR'),
(210,'Województwo wielkopolskie, Złotów','PZL'),
(211,'Województwo zachodniopomorskie, Koszalin','ZK'),
(212,'Województwo zachodniopomorskie, Szczecin','ZS'),
(213,'Województwo zachodniopomorskie, Świnoujście','ZSW'),
(214,'Województwo zachodniopomorskie, Białogard','ZBI'),
(215,'Województwo zachodniopomorskie, Choszczno','ZCH'),
(216,'Województwo zachodniopomorskie, Drawsko','ZDR'),
(217,'Województwo zachodniopomorskie, Goleniów','ZGL'),
(218,'Województwo zachodniopomorskie, Gryfice','ZGY'),
(219,'Województwo zachodniopomorskie, Gryfino','ZGR'),
(220,'Województwo zachodniopomorskie, Kamień Pomorski','ZKA'),
(221,'Województwo zachodniopomorskie, Kołobrzeg','ZKL'),
(222,'Województwo zachodniopomorskie, Koszalin powiat','ZKO'),
(223,'Województwo zachodniopomorskie, Myślibórz','ZMY'),
(224,'Województwo zachodniopomorskie, Police','ZPL'),
(225,'Województwo zachodniopomorskie, Pyrzyce','ZPY'),
(226,'Województwo zachodniopomorskie, Sławno','ZSL'),
(227,'Województwo zachodniopomorskie, Stargard Szczeciński','ZST'),
(228,'Województwo zachodniopomorskie, Szczecinek','ZSZ'),
(229,'Województwo zachodniopomorskie, Świdwin','ZSD'),
(230,'Województwo zachodniopomorskie, Wałcz','ZWA'),
(231,'Województwo dolnośląskie, Jelenia Góra','DJ'),
(232,'Województwo dolnośląskie, Legnica','DL'),
(233,'Województwo dolnośląskie, Wałbrzych','DB'),
(234,'Województwo dolnośląskie, Wrocław','DW'),
(235,'Województwo dolnośląskie, Bolesławiec','DBL'),
(236,'Województwo dolnośląskie, Dzierżoniów','DDZ'),
(237,'Województwo dolnośląskie, Głogów','DGL'),
(238,'Województwo dolnośląskie, Góra','DGR'),
(239,'Województwo dolnośląskie, Jawor','DJA'),
(240,'Województwo dolnośląskie, Jelenia Góra powiat','DJE'),
(241,'Województwo dolnośląskie, Kamienna Góra','DKA'),
(242,'Województwo dolnośląskie, Kłodzko','DKL'),
(243,'Województwo dolnośląskie, Legnica powiat','DLE'),
(244,'Województwo dolnośląskie, Lubań','DLB'),
(245,'Województwo dolnośląskie, Lubin','DLU'),
(246,'Województwo dolnośląskie, Lwówek','DLW'),
(247,'Województwo dolnośląskie, Milicz','DMI'),
(248,'Województwo dolnośląskie, Oleśnica','DOL'),
(249,'Województwo dolnośląskie, Oława','DOA'),
(250,'Województwo dolnośląskie, Polkowice','DPL'),
(251,'Województwo dolnośląskie, Strzelin','DST'),
(252,'Województwo dolnośląskie, Środa Śląska','DSR'),
(253,'Województwo dolnośląskie, Świdnica','DSW'),
(254,'Województwo dolnośląskie, Trzebnica','DTR'),
(255,'Województwo dolnośląskie, Wałbrzych powiat','DBA'),
(256,'Województwo dolnośląskie, Wołów','DWL'),
(257,'Województwo dolnośląskie, Wrocław powiat','DWR'),
(258,'Województwo dolnośląskie, Ząbkowice','DZA'),
(259,'Województwo dolnośląskie, Zgorzelec','DZG'),
(260,'Województwo dolnośląskie, Złotoryja','DZL'),
(261,'Województwo kujawsko-pomorskie, Świecie','CSW'),
(262,'Województwo kujawsko-pomorskie, Toruń powiat','CTR'),
(263,'Województwo kujawsko-pomorskie, Tuchola','CTU'),
(264,'Województwo kujawsko-pomorskie, Wąbrzeźno','CWA'),
(265,'Województwo kujawsko-pomorskie, Włocławek powiat','CWL'),
(266,'Województwo kujawsko-pomorskie, Żnin','CZN'),
(267,'Województwo kujawsko-pomorskie, Bydgoszcz','CB'),
(268,'Województwo kujawsko-pomorskie, Grudziądz','CG'),
(269,'Województwo kujawsko-pomorskie, Toruń','CT'),
(270,'Województwo kujawsko-pomorskie, Włocławek','CW'),
(271,'Województwo kujawsko-pomorskie, Aleksandrów Kujawski','CAL'),
(272,'Województwo kujawsko-pomorskie, Brodnica','CBR'),
(273,'Województwo kujawsko-pomorskie, Bydgoszcz powiat','CBY'),
(274,'Województwo kujawsko-pomorskie, Chełmno','CCH'),
(275,'Województwo kujawsko-pomorskie, Golub-Dobrzyń','CGD'),
(276,'Województwo kujawsko-pomorskie, Grudziądz powiat','CGR'),
(277,'Województwo kujawsko-pomorskie, Inowrocław','CIN'),
(278,'Województwo kujawsko-pomorskie, Lipno','CLI'),
(279,'Województwo kujawsko-pomorskie, Mogilno','CMG'),
(280,'Województwo kujawsko-pomorskie, Nakło nad Notecią','CNA'),
(281,'Województwo kujawsko-pomorskie, Radziejów','CRA'),
(282,'Województwo kujawsko-pomorskie, Rypin','CRY'),
(283,'Województwo kujawsko-pomorskie, Sępólno Krajeńskie','CSE'),
(284,'Województwo łódzkie, Łódź','EL'),
(285,'Województwo łódzkie, Piotrków Trybunalski','EP'),
(286,'Województwo łódzkie, Skierniewice','ES'),
(287,'Województwo łódzkie, Bełchatów','EBE'),
